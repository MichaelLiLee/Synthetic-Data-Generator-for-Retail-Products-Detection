...
"vitamin_centrumsilver_woman" : 62
    ...
    def __create_cryptomatte_nodes(self):
        """
        """
        ...
        ## reference node
        node_HueSaturationValue = bpy.data.scenes['Scene_Annot'].node_tree.nodes["Hue Saturation Value"]
        ## locate nodes
        node_Cryptomatte.location = (900, -300)
        node_Viewer.location = (1200,-300)

        ## link nodes
        links = bpy.data.scenes['Scene_Annot'].node_tree.links
        links.new(node_HueSaturationValue.outputs["Image"], node_Cryptomatte.inputs["Image"])
    ...
    def __find_obj_bbox(self):
        """ 
        """
        for i, obj_name in enumerate(self.__obj_name_and_id_dict):
            ...
            print(f"Remain Obj Num: {len(self.__obj_name_and_id_dict) - (i+1)}")
    ...
    def get_and_save_yolo_label(self):
        ...
        self.__create_cryptomatte_nodes()
